...
<div
    ...
    data-provider="<?php echo $data->provider ?>"
    data-screening-id="<?php echo $data->screening->_id() ?>"
    data-content-id="<?php echo $data->content_id ?>"
    data-allowed-ticket-types="<?php echo $data->allowed_ticket_types ?>"
>
