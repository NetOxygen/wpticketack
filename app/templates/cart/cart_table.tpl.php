                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <table class="tkt-cart-table">
                                <thead>
                                    <tr>
                                        <th scope="col"><?= tkt_t('Tickets') ?></th>
                                        <th scope="col" width="100px"><?= tkt_t('Prix') ?></th>
                            ...
                            <table class="tkt-cart-table">
                                <thead>
                                    <tr>
                                        <th scope="col"><?= tkt_t('Articles') ?></th>
                            ...
                            <table class="tkt-cart-table">
                                <thead>
                                    <tr>
                                        <th scope="col"><?= tkt_t('Abonnements') ?></th>
                                        <th scope="col" width="100px"></th>
                                        <th scope="col" width="20px"></th>
                                    </tr>
                                </thead>
