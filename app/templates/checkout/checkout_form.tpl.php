  ...
  <div class="row">
    <div class="col">
      <form class="checkout-form">
        ...
        <fieldset>
          <legend><?= tkt_t("Vos données de facturation") ?></legend>
          <div class="row">
            ...
            <div id="field-wrapper-firstname" class="field-wrapper col-md-6" style="display: block;">
              <div class="form-group">
                 ...
                 <input name="user[firstname]" type="text" class="form-control data-field" id="firstname" placeholder="<?= tkt_t("Votre prénom") ?>" <?= r($required_fields, 'firstname') ?> />
              </div>
            </div>
            <?php endif; ?>
            ...
            <div id="field-wrapper-lastname" class="field-wrapper col-md-6" style="display: block;">
              <div class="form-group">
                ...
                <input name="user[lastname]" type="text" class="form-control data-field" id="lastname" placeholder="<?= tkt_t("Votre nom") ?>" <?= r($required_fields, 'lastname') ?> />
              </div>
            </div>
            <?php endif; ?>
            ...
            <div id="field-wrapper-email" class="field-wrapper col-6" style="display: block;">
              <div class="form-group">
                ...
                <input name="user[email]" type="email" class="form-control data-field" id="email" placeholder="<?= tkt_t("Votre adresse e-mail") ?>" <?= r($required_fields, 'email') ?> />
              </div>
            </div>
            <div id="field-wrapper-email" class="field-wrapper col-6" style="display: block;">
              <div class="form-group">
                <label class="<?= r($required_fields, 'email') ?>" for="email"><?= tkt_t("Confirmation de votre adresse e-mail"); ?></label>
                <input name="user[email2]" type="email" class="form-control data-field" id="email" placeholder="<?= tkt_t("Saisissez une deuxième fois votre adresse") ?>" <?= r($required_fields, 'email') ?> />
              </div>
            </div>
            <?php endif; ?>
            ...
            <div id="field-wrapper-address" class="field-wrapper form-group col-12">
              ...
              <textarea name="user[address]" class="form-control data-field" id="address" placeholder="<?= tkt_t("Votre adresse") ?>" <?= r($required_fields, 'address') ?>></textarea>
            </div>
            <?php endif; ?>
            ...
            <?php if (in_array('zip', $requested_fields)) : ?> <div id="field-wrapper-zip" class="field-wrapper col-md-6">
              <div class="form-group">
                ...
                <input name="user[zip]" type="text" class="form-control data-field" id="zip" placeholder="<?= tkt_t("NPA") ?>" <?= r($required_fields, 'zip') ?> />
              </div>
            </div>
            <?php endif; ?>
            ...
            <div id="field-wrapper-city" class="field-wrapper col-md-6">
              <div class="form-group">
                ...
                <input name="user[city]" type="text" class="form-control data-field" id="city" placeholder="<?= tkt_t("Ville") ?>" <?= r($required_fields, 'city') ?> />
              </div>
            </div>
            <?php endif; ?>
            ...
            <div id="field-wrapper-phone" class="field-wrapper form-group col-6">
              ...
              <input name="user[phone]" type="tel" class="form-control data-field" id="phone" placeholder="<?= tkt_t("Votre numéro de téléphone") ?>" <?= r($required_fields, 'phone') ?> />
            </div>
            <?php endif; ?>
            ...
            <div id="field-wrapper-cellphone" class="field-wrapper form-group col-6">
              ...
              <input name="user[cellphone]" type="tel" class="form-control data-field" id="cellphone" placeholder="<?= tkt_t("Votre numéro de téléphone") ?>" <?= r($required_fields, 'cellphone') ?> />
            </div>
            <?php endif; ?>
        ...
        <fieldset>
          <div id="submit-section" class="row">
            <div class="col-md-12 text-right">
              <h3><span class="uppercase"><?= tkt_t('Total') ?>&nbsp;:</span> <span id="tkt-checkout-cart-amount"></span> <small>TTC</small></h3>
              <?php if ($allow_later) : ?>
              <button type="submit" class="submit-button btn btn-secondary" data-payment-method="LATER_PAYMENT" data-redirect="<?= $data->redirect ?>">
              <span class="glyphicon glyphicon-ok"></span> <?= tkt_t('Réserver (paiement sur place)') ?>
              </button>
              <?php endif; ?>

              <?php if ($allow_postfinance) : ?>
              <button type="submit" class="submit-button btn btn-success" data-payment-method="POSTFINANCE" data-redirect="<?= $data->redirect ?>">
