    ...
    <div class="row">
        ...
        <div class="col-sm-12">
            <div class="poster-wrapper">
                <a href="<?php echo tkt_article_details_url($article) ?>">
        ...
        <div class="col-sm-12">
            <h3 class="name">
                <a href="<?php echo tkt_article_details_url($article) ?>">
                    <?php echo $article->name(TKT_LANG) ?>
                </a>
            </h3>
        </div>

        <div class="col-sm-12 mt-4">
            <span class="short_description"><?php echo $article->short_description(TKT_LANG) ?></span>
        </div>

        <div class="col-sm-12 text-center mt-3 mb-3">
            <a class="button" href="<?php echo tkt_article_details_url($article) ?>">
                <?php echo tkt_t('Plus d\'informations'); ?>
            </a>
        </div>
        <div class="col-sm-12 text-center mt-3 mb-3">
        <?php if (!$article->has_stock_for_salepoint($salepoint_id)) : ?>
            <span class="article-out-of-stock"><?php echo tkt_t("Épuisé") ?></span>
            </br>
        <?php else : ?>
            </br>
            ...
            <div class="add-to-cart" data-component="Shop/Shop">
                ...
                <div
                    ...
                    data-article-id="<?php echo $article->_id() ?>"
                    data-salepoint-id="<?php echo $salepoint_id ?>"
                >
