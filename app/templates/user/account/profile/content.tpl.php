            ...
            <div class="row">
              ...
              <div id="field-wrapper-email" class="field-wrapper col-6" style="display: block;">
                <div class="form-group">
                  ...
                  <input name="user[contact][email]" type="email" class="tkt-input form-control data-field" id="email" placeholder="<?= tkt_t("Votre adresse e-mail") ?>" <?= r($required_fields, 'email') ?> readonly value="<%= user.contact.email %>" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,}" />
                </div>
              </div>
