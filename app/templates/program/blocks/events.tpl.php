...
<div id="tkt_program" class="tkt-wrapper tkt-blocks" data-component="Program/BookabilityState">
    <div class="container">
        ...
        <div class="row no-gutters">
            ...
            <div class="tkt_program_event<?php echo $data->items_per_row > 1 ? ' col-sm-6 p-4' : '' ?> col-12 col-md-<?php echo intval($nb_per_row) ?>" data-type="<?php echo $event->opaque('type') ?>" <?php echo tkt_event_data_attributes($event, $data->filter_fields) ?>>
