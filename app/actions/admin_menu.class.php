...
?>
        <div class="wrap">
            ...
            <h2 class="nav-tab-wrapper">
                ...
                <a
                    href="?page=ticketack-admin&tab=<?php echo $key ?>"
    ...
    {
?>
    <iframe id="kronos_iframe" frameborder="0" width="100%" height="100%" src="https://kronos.ticketack.com?v=<?php echo TKT_ASSETS_VERSION ?>" style="margin-left: -20px;"></iframe>
