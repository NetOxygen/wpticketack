...
class LocalesHelper
{
    public static function dump_js_locales()
    {
        return [
            ...
            'sur votre porte monnaie électronique'                                         => tkt_t('sur votre portefeuille électronique'),
            'Montant trop élevé'                                                           => tkt_t('Montant trop élevé'),
            'Portefeuille appliqué avec succès'                                            => tkt_t('Portefeuille appliqué avec succès'),
            'Impossible d\'utiliser votre portefeuille'                                    => tkt_t('Impossible d\'utiliser votre portefeuille'),
            'title'                                                                        => tkt_t('Nom'),
            'name'                                                                         => tkt_t('Nom'),
