...
* fix: Fix a bug in the booking form
...
* i18n: Fix some german translations

= 2.101.0 =

* feat(pricing): Add salepoint rule filtering
* fix(cart): Migrate legacy loadCart usage

= 2.100.3 =

* fix(models): Add missing Ref and Tag classes

= 2.100.2 =

* fix(program): Fix next screenings display

= 2.100.1 =

* fix(program): Fix program display
...
* fix: Fix a bug regarding the checkout url in the cart component
...
* fix: Fix a bug in the articles add to cart button
...
* fix: Fix the attachments management in the events importer

= 2.97.1 =

* fix: Fix the first name label in the buy pass form
* modified templates:
  - app/templates/buy_pass/form.tpl.php
...
* feat: Handle default termsn conditions and privacy urls
...
* feat: Enhance cannot book message when ticket is full

= 2.93.0 =

* feat: Add some spinners on booking form
...
* feat: Pre-fill checkout form with cart user data
* fix: Fix filter attributes

= 2.90.0 =

* feat: Prevent writing empty config file
* fix: Use more cache
* i18n: Enhance translations

= 2.89.6 =

* fix: Fix a bug regarding overlap rules

= 2.89.5 =

* fix: Fix a bug regarding required fields in buy pass shortcode
...
* fix: Fix a bug on user login
* fix: Fix a bug in the user account page

= 2.89.2 =

* fix: Fix a bug in the cart items price display

= 2.89.1 =

* fix: Update some template version

= 2.89.0 =

* fix: Fix the pass pricings description tooltips
* feat: Automatically detect Own It product ID using the refs source instead
  of the prefix

= 2.88.1 =

* fix: Fix PHP version dependency

= 2.88.0 =

* feat: Make a book on check call before movie stremaing

= 2.87.0 =

* feat: Introduce the buy pass with a quantity feature

= 2.86.0 =

* feat: Add cart display control with hide_items and hide_summary parameters

= 2.85.0 =

* feat: Introduce Own It integration
...
* feat: Better handle pages configuration

= 2.83.1 =

* fix: Use wp_make_link_relative for font paths in SCSS compilation
* i18n: Uniforize translation with eshop

= 2.83.0 =

* feat: Enhance templates versionning

= 2.82.0 =

* fix: Prevent notices duplication
* feat: Introduce templates versionning
* modified templates:
  - All the templates have been modified to introduce the @templateVersion:
    please adapt your overrides !
    Example:
    /**
     * Cart template
     *
...
* feat: Handle second Proxypay payment method
* modified templates:
  - app/templates/checkout/checkout.tpl.php
  - app/templates/checkout/checkout_form.tpl.php
...
* fix: Fix a bug in the pass description display
* fix: Fix more escaping errors
* fix: Fix a bug about the votes config
* modified templates:
