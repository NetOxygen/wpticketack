...
export default class Webcam extends Component {
    ...
    constructor($container, state) {
        ...
        this.passPhotoWidth = this.$container.data('width') || '300 px';
    }
    ...
    initCamera() {
        ...
        this.startup(this.video, this.canvas, /*width*/ this.passPhotoWidth, /*streaming*/false);
    };
    ...
    /**
     * Take picutre service
     *
     **/

    startup(video, canvas, width, streaming) {
        this.width = width;
