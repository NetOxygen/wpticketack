...
define('app/Articles/Article', [
    ...
    Article.prototype = {
        ...
        init: function init() {
            ...
            var $submit = $('.variants-submit', this.$container);
        ...
        hide_errors: function hide_errors() {
            this.$error.fadeOut();
...
define('app/Booking/Form', [
    ...
    Form.prototype = {
        ...
        build_dates_form: function build_dates_form() {
            ...
            var to_select = this.selected_screening;
            if (!to_select) {
...
define('app/Ui/Loader', [
    ...
    Loader.prototype = {
        ...
        init: function init() {
            ...
            var $spinner = $('<img/>').addClass('tkt-loader-spinner').attr('src', '/wp-content/themes/lafabrica/images/spinner.svg');
