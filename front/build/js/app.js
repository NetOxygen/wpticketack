        ...
        attach: function attach($targets, callback) {
            ...
            _.each($targets, function (componentItem) {
                ...
                _.each(components, function (componentName) {
                    if (!componentName)
                        return;
                    var is_wp_theme_component = _.startsWith(componentName, 'wp_theme');
                    var namespace = !is_wp_theme_component ? 'app/' : '';
                    tasks.push(function (done) {
                        require([namespace + componentName], function (Component) {
                            var c = void 0;
...
'use strict';
define('app/Booking/ScreeningsList', [
    'config',
    'i18n',
    'postal',
    'lodash',
    ...
    ScreeningsList.prototype = {
        ...
        build_dates_form: function build_dates_form() {
            var _this7 = this;
            this.$dates_form.html(Template.render('tkt-booking-screenings-list-dates-tpl', { screenings: this.data.screenings }));
            $('.dates-wrapper .date').click(function (e) {
                var $date = $(e.target);
                ;
                if (!$date.data('screening_id'))
                    $date = $date.closest('[data-screening_id]');
                var s_id = $date.data('screening_id');
                if (_this7.data.screening && _this7.data.screening._id == s_id)
                    _this7.unselect_screening();
                else
                    _this7.select_screening($date.data('screening_id'));
            });
            var s_to_select = this.selected_screening;
        ...
        build_tickets_form: function build_tickets_form() {
            ...
            $('.tkt-minus-btn', this.$container).click(function (e) {
                ...
                if (val > 1)
                    ...
                    $t.removeClass('tkt-dark-badge').addClass('tkt-grey-badge');
                _this8.show_or_hide_add_to_cart_button();
            });
            $('.tkt-plus-btn', this.$container).click(function (e) {
                var $t = $(e.target);
                var $input = $t.parent().next('.pricing-input').eq(0);
        ...
        deactivate_screening: function deactivate_screening() {
            $('.dates-wrapper .date').removeClass('active');
        },
        show_or_hide_add_to_cart_button: function show_or_hide_add_to_cart_button() {
            var chosen_pricings = _.find(this.data.pricings, function (nb) {
                return nb > 0;
            });
        ...
        unselect_screening: function unselect_screening(screening_id) {
...
define('app/Program/FilterRows', [
    ...
    function Filter($container, state) {
        ...
        this.target = this.$container.data('target') || '.tkt_program_event,.tkt_program_screening';
        this.$filters = $('.tkt-filter', this.$container);
    }
    Filter.prototype = {
        attach: function attach() {
        ...
        init: function init() {
            var _this = this;
            this.state = { filters: {} };
            this.criterium.map(function (k) {
                _this.update_state(k, '');
            });
            this.$filters.click(function (e) {
                return _this.handle_click(e);
            });
        ...
        handle_click: function handle_click(e) {
            ...
            var criteria = $filter.data('criteria');
            var value = $filter.data(criteria);
            this.update_state(criteria, value);
            this.sync_ui();
        },
        update_state: function update_state(criteria, value) {
            this.state.filters[criteria] = value;
        },
        sync_ui: function sync_ui() {
            var _this2 = this;
            $(this.target).addClass('to_show');
            this.criterium.map(function (criteria) {
                var value = _this2.state.filters[criteria];
...
!function (e, n) {
    'object' == typeof exports && 'undefined' != typeof module ? n(exports) : 'function' == typeof define && define.amd ? define('matchsorter', ['exports'], n) : n((e = e || self).matchSorter = {});
}(this, function (e) {
    'use strict';
    function n() {
    ...
    var r = {
            ...
            'Z̧': 'Z',
            'z̧': 'z'
        }, t = Object.keys(r).join('|'), a = new RegExp(t, 'g'), u = new RegExp(t, ''), o = function (e) {
    ...
    function E(e, n, r) {
        if (void 0 === r && (r = {}), !n)
            return e;
        var t = r, a = t.keys, u = t.threshold, o = void 0 === u ? f.MATCHES : u;
        return e.reduce(function (e, t, u) {
            var i = function (e, n, r, t) {
                    if (!n)
                        return {
                            rankedItem: e,
                            rank: d(e, r, t),
                    ...
                    return function (e, n) {
                        return n.reduce(function (n, r) {
                            var t = function (e, n) {
                                'object' == typeof n && (n = n.key);
                                var r;
                                r = 'function' == typeof n ? n(e) : -1 !== n.indexOf('.') ? n.split('.').reduce(function (e, n) {
                                    return e ? e[n] : null;
                                }, e) : e[n];
                    ...
                    }(e, n).reduce(function (e, n, a) {
                        var u = e.rank, o = e.rankedItem, i = e.keyIndex, A = e.keyThreshold, c = n.itemValue, s = n.attributes, E = d(c, r, t), l = o, C = s.minRanking, O = s.maxRanking, k = s.threshold;
                        return E < C && E >= f.MATCHES ? E = C : E > O && (E = O), E > u && (u = E, i = a, A = k, l = c), {
                            rankedItem: l,
                            rank: u,
                            keyIndex: i,
                            keyThreshold: A
                ...
                }(t, a, n, r), A = i.rankedItem, c = i.rank, s = i.keyIndex, E = i.keyThreshold;
            c >= (void 0 === E ? o : E) && e.push({
                rankedItem: A,
                item: t,
                rank: c,
                index: u,
            ...
            return e;
        }, []).sort(l).map(function (e) {
            return e.item;
        });
    }
    function d(e, n, r) {
        if (e = C(e, r), (n = C(n, r)).length > e.length)
            return f.NO_MATCH;
        if (e === n)
            return f.CASE_SENSITIVE_EQUAL;
        var t, a, u = function (e) {
                var n = e.toLowerCase() !== e, r = e.indexOf('-') >= 0, t = e.indexOf('_') >= 0;
                if (!n && !t && r)
                    return s.KEBAB;
                if (!n && t && !r)
                    return s.SNAKE;
                ...
                case s.PASCAL:
                case s.CAMEL:
                    return -1 !== t && e[t] === e[t].toUpperCase();
                default:
                    return !1;
                }
            }(e, n, u), i = function (e, n, r) {
                var t = null;
                switch (r) {
                case s.SNAKE:
                    t = '_';
                ...
                var a = e.split(t);
                return n.toLowerCase().split('').reduce(function (e, n, r) {
                    var t = a[r];
                    return e && t && t[0].toLowerCase() === n;
                }, !0);
            }(e, n, u);
        return (e = e.toLowerCase()) === (n = n.toLowerCase()) ? f.EQUAL + u : 0 === e.indexOf(n) ? f.STARTS_WITH + u : -1 !== e.indexOf(' ' + n) ? f.WORD_STARTS_WITH + u : o ? f.STRING_CASE + u : u > 0 && i ? f.STRING_CASE_ACRONYM + u : -1 !== e.indexOf(n) ? f.CONTAINS + u : 1 === n.length ? f.NO_MATCH : -1 !== (t = e, a = '', t.split(' ').forEach(function (e) {
            e.split('-').forEach(function (e) {
                a += e.substr(0, 1);
            });
        }), a).indexOf(n) ? f.ACRONYM + u : function (e, n) {
            var r = 0, t = 0;
            function a(e, n, t) {
            ...
            return function (e) {
                var t = r / n.length;
                return f.MATCHES + t * (1 / e);
            }(t - u);
        }(e, n);
    }
    function l(e, n) {
        var r = e.rankedItem, t = e.rank, a = e.keyIndex, u = n.rankedItem, o = n.rank, i = n.keyIndex;
        return t === o ? a === i ? String(r).localeCompare(u) : a < i ? -1 : 1 : t > o ? -1 : 1;
    }
    function C(e, n) {
        return e = '' + e, n.keepDiacritics || (e = i(e)), e;
    }
    function O(e) {
        return 'string' == typeof e && (e = { key: e }), n({
            maxRanking: 1 / 0,
            minRanking: -1 / 0
        }, e);
    }
    E.rankings = f, E.caseRankings = s, e.default = E, e.rankings = f, Object.defineProperty(e, '__esModule', { value: !0 });
});
'use strict';
define('app/People/Filter', [
    'jquery',
    'lodash',
    'urijs',
    'matchsorter'
    ...
    Filter.prototype = {
        ...
        init: function init() {
            ...
            [
                ...
                _this['$filters_' + filter].on('click', function (e) {
                    e.preventDefault();
                    var $link = $(e.target);
                    var href = $link.attr('href');
                    _this.set_filter_value(filter, $link.attr('href'));
                    _this.run();
                });
            });
            ['tags'].map(function (filter) {
                _this['$filters_' + filter].on('input', _.debounce(function (e) {
                    _this.set_filter_value(filter, e.target.value);
                    _this.run();
                }, 250));
            });
            this.run();
        },
        set_filter_value: function set_filter_value(filter, value) {
            this.state.filters[filter] = this.clean_filter_value(value);
            this.sync_dom_with_state_filters();
            this.sync_url_with_state_filters();
        },
        sync_dom_with_state_filters: function sync_dom_with_state_filters() {
            var _this2 = this;
            [
                'country',
                'company',
                ...
                _this2['$filters_' + filter].removeClass('active');
                var filter_value = _this2.state.filters[filter];
                if (filter_value) {
                    var $active_link = $('a[href="#' + filter_value + '"]', _this2.$container);
            ...
            ['tags'].map(function (filter) {
                var filter_value = _this2.state.filters[filter];
                if (filter_value) {
                    _this2['$filters_' + filter].val(filter_value);
                }
            });
        },
        sync_url_with_state_filters: function sync_url_with_state_filters() {
            var _this3 = this;
            var new_url = new URI(window.location.href);
            [
                'country',
                'company',
                'profession',
                ...
                if (_this3.state.filters[filter]) {
                    new_url.setQuery(filter, _this3.state.filters[filter]);
                }
            });
            window.history.pushState('', 'Title', new_url.toString());
        },
        sync_state_with_url: function sync_state_with_url() {
            var url = new URI(window.location.href);
            var query = URI.parseQuery(url.query());
            this.state.filters = _.defaults(this.state.filters, query);
        },
        sync_total_by_filter_value: function sync_total_by_filter_value() {
            var _this4 = this;
            [
                'country',
                'company',
                ...
                _this4['$filters_' + filter].parent('li:not(.reset-filter)').removeClass('to_show');
                _this4['$filters_' + filter].map(function (i, link) {
                    var filter_value = _this4.clean_filter_value($(link).attr('href'));
                    var shown_person = _this4.$person.filter('[data-' + filter + '="' + filter_value + '"].to_show').length;
                    $('.tkt-filter-' + filter + '-total[data-' + filter + '="' + filter_value + '"]').html(shown_person);
                    if (shown_person > 0) {
                        _this4['$filters_' + filter].filter('[href="#' + filter_value + '"]').parent('li').addClass('to_show');
                    }
                });
                _this4['$filters_' + filter].parent('li:not(.reset-filter)').hide();
                _this4['$filters_' + filter].parent('li.to_show').fadeIn();
            });
        },
        run: function run() {
        ...
        clean_filter_value: function clean_filter_value(value) {
            if (!value) {
                return value;
            }
            return value.replace('#', '');
        },
        handle_filters: function handle_filters() {
            var _this5 = this;
            ...
            [
                ...
                if (_this5.state.filters[filter]) {
                    var filter_value = _this5.state.filters[filter];
                    _this5.$person.not('[data-' + filter + '="' + filter_value + '"]').removeClass('to_show');
                }
            });
            var ms = matchsorter.default;
            ['tags'].map(function (filter) {
                if (_this5.state.filters[filter]) {
                    _this5.$person.map(function (i, person) {
                        var match = ms([$(person).data(filter)], _this5.state.filters[filter], { threshold: ms.rankings.CONTAINS });
                        if (!match.length) {
